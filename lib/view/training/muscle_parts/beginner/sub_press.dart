...
class SubPressBeginner extends StatefulWidget {
  const SubPressBeginner({super.key});

  @override
  State<SubPressBeginner> createState() => _SubPressBeginnerState();
}

class _SubPressBeginnerState extends State<SubPressBeginner> {
  late Future<List<String>> imageUrls;

  @override
  void initState() {
    super.initState();
    imageUrls = StorageService.loadImages('pressbeginner');
  }
        ...
        builder: (context, snapshot) {
          ...
          return FloatingActionButton.extended(
            onPressed: () => startTraining(
              imageUrls,
              string.beginnerpress,
              string.beginnerpressnumber,
            ),

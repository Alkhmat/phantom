...
class SubLegsExperince extends StatefulWidget {
  const SubLegsExperince({super.key});

  @override
  State<SubLegsExperince> createState() => _SubLegsExperinceState();
}

class _SubLegsExperinceState extends State<SubLegsExperince> {
  late Future<List<String>> imageUrls;

  @override
  void initState() {
    super.initState();
    imageUrls = StorageService.loadImages('experiencelegs');
  }
        ...
        builder: (context, snapshot) {
          ...
          return FloatingActionButton.extended(
            onPressed: () => startTraining(
              imageUrls,
              string.experienceleg,
              string.experiencelegnumber,
            ),
